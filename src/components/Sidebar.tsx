  ...
  return (
    <>
      ...
      >
        ...
        {/* Bottom section with theme and settings */}
        <div className="flex-shrink-0 border-t border-border px-3 py-2 space-y-1">
          <button
            onClick={toggleTheme}
            className="w-full flex items-center gap-2 px-2 py-1.5 rounded-md text-secondary hover:text-foreground hover:bg-card transition-colors"

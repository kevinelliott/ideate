...
export function Sidebar({ onNewProject, onQuickAddProject, onImportProject }: SidebarProps) {
  ...
  const showSpecifications = useProjectStore((state) => state.showSpecifications)
  const showDesign = useProjectStore((state) => state.showDesign)
                      ...
                      <ul className="ml-3 mt-0.5 space-y-0.5 border-l border-border pl-2">
                        ...
                        <li>
                          <div
                            ...
                            className={`flex items-center gap-2 px-2 py-1 rounded-md text-xs transition-colors cursor-pointer ${
                              projectPages[project.id] === 'requirements'
                                ? 'bg-card text-foreground font-medium'
                                : 'text-secondary hover:text-foreground hover:bg-card/50'
                            }`}
                          >
                        ...
                        <li>
                          <div
                            onClick={() => { selectIdea(null); selectProcess(null); showSpecifications(project.id); }}
                            className={`flex items-center gap-2 px-2 py-1 rounded-md text-xs transition-colors cursor-pointer ${
                              projectPages[project.id] === 'specifications'
                                ? 'bg-card text-foreground font-medium'
                                : 'text-secondary hover:text-foreground hover:bg-card/50'
                            }`}
                          >
                        ...
                        <li>
                          <div
                            onClick={() => { selectIdea(null); selectProcess(null); showDesign(project.id); }}
                            className={`flex items-center gap-2 px-2 py-1 rounded-md text-xs transition-colors cursor-pointer ${
                              projectPages[project.id] === 'design'
                                ? 'bg-card text-foreground font-medium'
                                : 'text-secondary hover:text-foreground hover:bg-card/50'
                            }`}
                          >
